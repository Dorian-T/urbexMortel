...
obj/Game.o: src/core/Game.h src/core/Game.cpp $(B_PATH)Building.h $(E_PATH)Player.h
...
bin/main_txt: obj/main_txt.o obj/winTxt.o obj/txtGame.o
	g++ -g -Wall obj/main_txt.o obj/winTxt.o obj/txtGame.o -o bin/main_txt
